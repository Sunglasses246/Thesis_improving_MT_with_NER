...
Arabic: "ماريا كانت تتحدث عن "ذا جاي

English: When did Galileo cross the Alps?
Arabic: متى عبر جاليليو الالبس؟

English: How did the Rebels from Star Wars destroy the Death Star?
Arabic: كيف حطم الثوار من ستار ورز نجمة الموت؟
...
df_translation.to_csv("translation_PE_FS_Gemma_AE_Naglaa.csv", index=False)

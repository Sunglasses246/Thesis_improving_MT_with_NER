...
XCT_DE = pd.read_json("/home/sbosch/Experiment/ml-kg-mt/data/xct/references/all/it_IT.jsonl", lines = True)
...
Translate from English to Italian (Italy).
...
Italian (Italy): Maria stava parlando di The Guy.
...
- Step 4: Galileo will be Galileo and Alps will be Alpi.
Italian (Italy): Quando attraversò Galileo le Alpi?
...
- Step 4: Rebels will be translated as i Ribelli, Star Wars as Star Wars and Death Star as Morte Nera.
Italian (Italy): Come hanno distrutto la Morte Nera i Ribelli di Star Wars?
...
df_translation.to_csv("translation_COT_LLAMA_IT.csv", index=False)

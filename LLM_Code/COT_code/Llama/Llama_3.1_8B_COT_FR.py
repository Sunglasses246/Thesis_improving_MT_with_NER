...
XCT_DE = pd.read_json("/home/sbosch/Experiment/ml-kg-mt/data/xct/references/all/fr_FR.jsonl", lines = True)
...
Translate from English to French (France).
...
French (France): Maria parlait de The Guy.
...
French (France): Quand Galileo a-t-il traversé les Alpes ?
...
- Step 4: Rebels will be translated as Rebelles, Star Wars as Star Wars and Death Star as l’Étoile de la Mort.
French (France): Comment les Rebelles de Star Wars ont-ils détruit l’Étoile de la Mort?
...
df_translation.to_csv("translation_COT_LLAMA_FR.csv", index=False)

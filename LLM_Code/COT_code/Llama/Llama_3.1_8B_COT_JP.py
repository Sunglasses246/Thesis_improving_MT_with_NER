...
XCT_DE = pd.read_json("/home/sbosch/Experiment/ml-kg-mt/data/xct/references/all/ja_JP.jsonl", lines = True)
...
Translate from English to Japanese (Japan).
...
- Step 4: Maria will be translated as マリア and the Guy as the Guy.
Japanese (Japan): マリアは「The Guy」について話していた。
...
- Step 4: Galileo will be ガリレオ and Alps will be アルプス山脈.
Japanese (Japan): ガリレオはいつアルプス山脈を越えたのか。
...
- Step 4: Rebels will be translated as 反乱軍, Star Wars as 『スター・ウォーズ』 and Death Star as デス・スター.
Japanese (Japan): 『スター・ウォーズ』の反乱軍はどのようにしてデス・スターを破壊したのか。
...
df_translation.to_csv("translation_COT_LLAMA_JP.csv", index=False)

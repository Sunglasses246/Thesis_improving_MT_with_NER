...
Translate from English to Chinese (China).
...
- Step 4: Maria will be translated as 瑪麗亞 and the Guy as 盖伊  
Chinese (China): 瑪麗亞在談論盖伊。
...
- Step 4: Galileo will be 伽利略 and Alps will be 阿尔卑斯山.
Chinese (China): 伽利略何时穿越阿尔卑斯山？
...
- Step 4: Rebels will be translated as 反抗军, Star Wars as 《星球大战》 and Death Star as 死星.
Chinese (China): 《星球大战》中的反抗军是如何摧毁死星的？
...
df_translation.to_csv("translation_COT_LLAMA_CH.csv", index=False)

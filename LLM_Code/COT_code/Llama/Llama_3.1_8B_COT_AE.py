...
XCT_DE = pd.read_json("/home/sbosch/Experiment/ml-kg-mt/data/xct/references/all/ar_AE.jsonl", lines = True)
...
- Step 4: Maria will be translated as ماريا and the Guy as the Guy.  
Arabic: كانت ماريا تتحدث عن «The Guy».
...
- Step 4: Galileo will be غاليليو and Alps will be جبال الألب.
Arabic: متى عبر غاليليو جبال الألب؟
...
- Step 4: Rebels will be translated as المتمردون, Star Wars as ستار وورز and Death Star as نجم الموت.
Arabic: كيف دمّر المتمردون من ستار وورز نجم الموت؟
...
df_translation.to_csv("translation_COT_LLAMA_AE.csv", index=False)

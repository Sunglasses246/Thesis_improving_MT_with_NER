...
- Step 4: Galileo will be Galileo and Alps will be Alpleri.
...
- Step 4: Rebels will be translated as İsyancılar, Star Wars as Star Wars and Death Star as Ölüm Yıldızı.
...
df_translation.to_csv("translation_COT_LLAMA_TR.csv", index=False)

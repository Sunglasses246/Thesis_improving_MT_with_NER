...
- Step 4: Maria will be translated as มาเรีย and the Guy as the Guy.
...
- Step 4: Galileo will be กาลิเลโอ and Alps will be เทือกเขาแอลป์.
...
- Step 4: Rebels will be translated as กบฏ, Star Wars as สตาร์ วอร์ส and Death Star as เดธสตาร์.
...
df_translation.to_csv("translation_COT_LLAMA_TH.csv", index=False)

...
- Step 4: Maria will be translated as 마리아 and the Guy as the Guy.
Korean (Korea): 마리아는 ‘The Guy’에 대해 이야기하고 있었다.
...
- Step 4: Galileo will be 갈릴레오 and Alps will be 알프스.
Korean (Korea): 갈릴레오는 언제 알프스를 넘었는가?
...
- Step 4: Rebels will be translated as 반란군, Star Wars as 스타워즈 and Death Star as 데스스타.
Korean (Korea): ‘스타워즈’의 반란군은 어떻게 데스스타를 파괴했는가?
...
df_translation.to_csv("translation_COT_LLAMA_KR.csv", index=False)
